...
public class GWTSpring implements EntryPoint {
	...
	public void onModuleLoad() {
		...
		employeeInfoField.setText("id name surname jobTitle");
		employeeInfoField.setWidth("200px");
		final TextBox employeeIdField = new TextBox();
		employeeIdField.setWidth("200px");
		...
		final GWTComposite compositeElement = new GWTComposite();
		...
		RootPanel.get("compositeElement").add(compositeElement);
